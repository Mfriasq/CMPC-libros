# Script de inicio completo desde cero - MODO DESARROLLO
# Elimina todos los contenedores y datos anteriores y crea todo nuevo

Write-Host "INICIANDO Sistema de Biblioteca desde CERO (DESARROLLO)..." -ForegroundColor Green
Write-Host ""
...
# 5. Construir e iniciar servicios en modo desarrollo
Write-Host "Construyendo e iniciando servicios (DESARROLLO)..." -ForegroundColor Cyan
...
Write-Host "Backend API: http://localhost:3001 (Hot Reload)" -ForegroundColor White
...
Write-Host ""
Write-Host "Sistema de desarrollo iniciado correctamente!" -ForegroundColor Green